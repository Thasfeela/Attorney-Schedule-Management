				...
				<div class="row">
					<?php
						...
						<div class="col-md-6">
							...
							<div class="card text-center p-4">
									...
									<div class="card-header">
											<label>	<b><h4>About Lawyer</h4></b></label>
									...
									<div class="card-body p-1">
										<div class="infogroup row">
											...
											<div class="col-md-8">
												<p><?php echo $row["degree"], '&nbsp;from&nbsp;', $row["university_College"],'&nbsp;(',$row["passing_year"],')';  ?></p>
											</div>
										</div>
										<div class="infogroup row">
											<div class="col-md-4">
										...
										<div class="infogroup row">
											<div class="col-md-4">
												<label for="email"><b>Practising court</b></label>
											</div>
											<div class="col-md-8">
												<p><?php echo $row["court"]; ?></p>
											</div>
										</div>
										<div class="infogroup row">
											<div class="col-md-4">
										...
										<div class="infogroup row">
											<div class="col-md-4">
												<label for="email"><b>Case handles:</b></label>
											</div>
											<div class="col-md-8">
						...
						<div class="mainprofile">
							<div class="card text-center p-4">
									<div class="card-header">
										<label>	<b><h4>Get Your Appointment</h4></b></label>
									...
									<div class="card-body p-1">
										<form action="save_booking.php" method="post">
											   ...
											   $date = date('Y-m-d'); ?>
													...
													<input class="form-control" type="date" name="date" min="<?php echo $date; ?>">
												</div>
											<div class="form-group">
												<textarea class="form-control" name="description" id="" cols="20" rows="4" placeholder="write description if any"></textarea>
											</div>
