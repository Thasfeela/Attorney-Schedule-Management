												...
												<div class="col-md-10">
													<form  action="save_lawyer_edit_Profile.php"  method="post" enctype="multipart/form-data"  id="validateForm">
														<div class="form-group">
															...
															<input type="text" class="form-control" name="enum" id="enum" value="<?php echo $row["lawyer_id"]; ?>" readonly>
														</div>
														<div class="form-row">
														...
														<div class="form-row">
															<div class="form-group col-md-6">
																...
																<input type="text" class="form-control" id="institute" name="university_College" value="<?php echo $row["university_College"]; ?>" required>
															</div>
														...
														<div class="form-row">
															<div class="form-group col-md-6">
																...
																<input type="text" class="form-control" id="address" name="full_address" value="<?php echo $row["full_address"]; ?>" required>
															</div>
															<div class="form-group col-md-3">
														...
														<div class="form-group">
															...
															<select id="practise" name="practise_Length" class="form-control" required>
																<option value=" " selected>Choose...</option>
														...
														<div class="form-group">
															...
															<select id="practise" name="speciality" class="form-control" required>
																<option value=" " selected>Choose...</option>
