									...
									<div class="card">
                                	    <div class="card-header">
                                	      <ul class="nav nav-tabs card-header-tabs" id="bologna-list" role="tablist">
                                	        <li class="nav-item">
                                	          <a class="nav-link active" href="appointment.php?name=<?php echo $name; ?> & des=<?php echo $des; ?> & d=<?php echo $d; ?> & u=<?php echo $u; ?>" role="tab" aria-selected="true">Appointment<span class="sr-only">(current)</span></a>
                                	        </li>
                                	        <li class="nav-item">
                                	          <a class="nav-link"  href="single_client.php?u=<?php echo $u; ?> & name=<?php echo $name; ?> & des=<?php echo $des; ?> & d=<?php echo $d; ?> & u=<?php echo $u; ?>" role="tab" aria-controls="history" aria-selected="false">Client Profile</a>
                                	        </li>
                                	        <li class="nav-item">
                                	          <a class="nav-link" href="booking.php?u=<?php echo $u; ?> & name=<?php echo $name; ?> & des=<?php echo $des; ?> & d=<?php echo $d; ?> & u=<?php echo $u; ?>" role="tab" aria-controls="deals" >Case Details</a>
                                	        </li>
                                	      </ul>
                                	    </div>
										<div class="card-body">
...
//$booking_id = $_POST["booking_id"];
 $query="update booking set time='$etime' , amount ='$amt' where client_id='$u' and lawyer_id='$a' and description='$des'";  
