      ...
      <ul class="nav nav-pills">
        ...
        <li class="nav-item"><a href="case_dates.php?u=<?php echo $u; ?> & b=<?php echo $b; ?>" class="nav-link">case updates</a></li>
					                ...
					                ?>
													...
													<input type="hidden" name="u"  value="<?php echo $row['u_id']; ?>">
																	...
																	<div class="container p-3 my-3 bg-light text-dark" id="c1">
																		...
																		<div class="form-row">
																				<div class="form-group col-md-6">
																					...
																					<input type="text" class="form-control" name="case_num"  id="case_num">
																				</div>
																				<div class="form-group col-md-6">
																			...
																			<div class="form-group col-md-6">
																					...
																					<input type="text" class="form-control" name="act"  id="hdate">
																				</div>
																				<div class="form-group col-md-6">
																					<label  for="lname">First Hearing date</label>
																				...
																				<textarea class="form-control" name="facts" id="" cols="20" rows="1" placeholder="write short description"></textarea>
																			</div>
                                                                            
                                                                            <div class="form-group" id="evi">
																					
																				<label  for="practise">Evidence</label>
																				<textarea class="form-control" name="evidence" id="evi" cols="20" rows="1" placeholder="evidences"></textarea>
																			</div>
																			<div class="form-group" id="wit">
																					
																				<label  for="practise">witness</label>
																				<textarea class="form-control" name="witness" id="wit" cols="20" rows="1" placeholder="witness"></textarea>
																			</div>
													...
													<div class="form-group col-md-2">
													<a class="btn btn-large btn-info btn-outline-secondary" href="case_update.php?u=<?php echo $u;?> & b=<?php echo $b; ?>">update</a></td>
													</div>
												</div>
...
$query1="insert into case_details(case_num,client_id,lawyer_id,court,filing_date,ctype,sub,status,statement,evidence,witness,act,booking_id,station_details)
values('$case_num','$u','$lawyer','$court','$fdate','$ctype','$sub','$status','$facts','$evidence','$witness','$act','$booking_id','yes')";
$res1 = mysqli_query($con, $query1);
if($res1){
	$query2="insert into result(case_num,result,details,hdate,num) values ('$case_num','Select','','$hdate','1')";
	...
	echo"<script type='text/javascript'>alert('inserted Successfully!');</script>";
			echo "<script type='text/javascript'>
					 window.location.href = 'case_responent.php?u=$u & b=$b';
				 </script>";
}
}
 else {
