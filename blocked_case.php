									...
									<!--<form method="POST" action="payment.php">	-->
										<table class="table table-hover table-responsive">
											...
											<?php
												...
												$conn = connect();
												$result = mysqli_query($conn,"SELECT description,first_Name,last_Name,date,time,booking.booking_id as bk,lawyer.lawyer_id as l,booking.status as statuss
												...
												while($row = mysqli_fetch_array($result)) {
													...
													if(($row['statuss']=="Cancelled")|| ($row['statuss']=="Blocked")){
