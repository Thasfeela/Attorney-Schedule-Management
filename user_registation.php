<header>
	...
	<script>
		...
		function MyCheckFn(){
			...
			window.load = function(){
				window.location='http://localhost/lawyermanagementsystem-main/user_register.php';
			});
		}
	</script>
</header>
<?php
	...
	if($okFlag){
		...
		$alt_number = $_REQUEST['alt_number'];
        ...
        else
        {
          ...
          //echo $sql;exit;
		   $result=mysqli_query($conn, $sql) or die(mysqli_error ($conn));
            if($result==1)
            {
                $sql2= "INSERT INTO `client` (`client_id`, `Age`, `Gender`, `Occupation`, `contact_number`, `alt_number`, `full_address`, `city`, `zip_code`, `image`, `aadhar`, `caste`, `religion`) VALUES ('$u_id', '$age', '$gender', '$Occupation', '$contact_number', '$alt_number', '$full_address', '$city', '$zip_code ', '$newName ', '$n ','$caste','$religion');";
