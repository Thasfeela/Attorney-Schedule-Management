										...
										<table class="table table-hover table-responsive">
											...
											<?php
												...
												while($row = mysqli_fetch_array($result)) {
														...
														$t = $row['bk'];
															$qry = mysqli_query($conn,"select * from case_details where booking_id='$t' and status='Closed'");
															while($r = mysqli_fetch_array($qry)) {
                                                                $query = mysqli_query($conn,"select * from result where result='Lose' and case_num='" . $r['case_num'] . "'");
																while($rwq = mysqli_fetch_array($query)) {
												?>
												<tbody id="myTable">
													<tr>
