								...
								<br>
									...
									<div class=" container col-md-12 bg-light text-dar">
										...
										<table class="table table-hover table-responsive">
                                            ...
                                            <?php $result1 = mysqli_query($conn,"SELECT * from payment,booking,more_pay where payment.booking_id = booking.booking_id and payment.client_id = '$a' and more_pay.booking_id= '$bk' and more_pay.mpid= payment.mpid and payment.lawyer_id = '" .$row['lawyer_id'] ."'");
