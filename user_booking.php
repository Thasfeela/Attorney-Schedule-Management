											...
											<?php
												...
												<tbody id="myTable">
													...
													<input type="hidden" name="booking_id"  value="<?php echo $row['bk']; ?>">
														...
														<td><a class="nav-link btn btn-block btn-info" href="payment.php?b=<?php echo $row['bk']; ?>" name="submit" >Payment</a>
												        ...
												        <?php
															...
															<td><a class="nav-link btn btn-block btn-info disabled" href="payment.php?b=<?php echo $row['bk']; ?>" name="submit" >Payment</a>
														...
														<?php if ($row['statuss'] != 'Accepted'){
															...
															?>
														<td><a class="nav-link btn btn-block btn-info btn-danger" href="user_booking.php?block_id=<?=$row['bk']?>" name="submit" >Cancel</a>
													</tr>
													<?php
													}
												}
