											...
											<hr style="width:100%;text-align:left;margin-left:0">	
					                        	...
					                        	while($row = mysqli_fetch_array($result)) 
												{
													...
													while($f = mysqli_fetch_array($res2))
													{
														...
														$ct = $f['ctype'] ;
														if($ct == 'Family law'){
															echo "no police station details needed";
														}else{
																			...
																			<div class="container p-3 my-3 bg-light text-dark" id="c1">
																				<div class="col-md-10">
																									...
																									<div class="form-group col-md-4">
																											...
																											<input type="text" class="form-control" name="ploc">
																									</div>
																									<div class="form-group col-md-4">
                                    						                                    ...
                                    						                                    <div class="form-row">
																									<div class="form-group col-md-6">
																											<label  for="lname">Date of Offense</label>
																											<input type="date" class="form-control" name="odate"  >
																									</div>
																									<div class="form-group col-md-6">
																											<label  for="lname">Date of filing charge sheet</label>
                                    						                                ...
                                    						                                <div class="form-group col-md-6">
																								...
																								<div class="form-row">
																									<div class="form-group col-md-6">
																											...
																											<input type="text" class="form-control" name="off1"  >
																									</div>
																									<div class="form-group col-md-6">
																										<label  for="lname">Investigating Officer 1</label>
																										<input type="text" class="form-control" name="off2"  >
																									</div>
																								</div>
																			   ...
																			   <div class="form-group col-md-2">
																				<a class="btn btn-large btn-info btn-outline-secondary" href="station_update.php?u=<?php echo $u;?> & b=<?php echo $b; ?>">update</a></td>
																				</div>
																		   </div>
...
$query3 = "insert into station (p_id,case_num,name,address,location,pincode,o_date,c_date,firtype,firno,officer1,officer2,contact,alt_phn,booking_id)
            values ('$p_id','$case_num','$pname','$paddr','$ploc','$pin','$odate','$cdate','$ftype','$fno','$off1','$off2','$num','$alt','$booking_id')";
            echo $query3;
