			...
			<body>
				<div class="d-flex" id="wrapper">
					...
					<section class="payment"><br><br>
						...
						<div class="container col-md-7 bg-light text-dark"><br><br>
						<div class="row">
								...
								<div class="col-md-7">
									<form action="" method="post">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control"  name="ctype" id="ctype" placeholder="Enter case type">
										</div>
										
		
										<input name="submit" type="submit" class="btn btn-block btn-success" value="submit" /><br><br>
...
if(isset($_POST["submit"]))
{
	...
	$query="insert into case_type (type) values ('$ctype')";
