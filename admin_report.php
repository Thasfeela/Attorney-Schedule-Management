							...
							<div class="span7">  
								<div class="col-md-12">
									...
									<div class="card-header">
                                	      <h4><CENTER><i>CASE REPORT</CENTER></h4>
                                	    </div>
										<div class="card-body">
									...
									<?php 
														...
														$query = "select * from case_details,booking where case_details.booking_id=booking.booking_id and case_details.booking_id = '$b'";
