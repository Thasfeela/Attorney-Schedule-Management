				...
				<div class="row">
					...
					<div class="col-md-6">
						<form action="user_registation.php" method="POST" enctype="multipart/form-data" id="validateForm">
							...
							<div class="form-row">
								<div class="form-group col-md-6">
									<label for="fname">Caste</label>
									<input type="text" class="form-control" name="caste"  id="first_Name" placeholder="first name" required>
								</div>
								<div class="form-group col-md-6">
									<label for="lname">Religion</label>
									<input type="text" class="form-control" name="religion"  id="last_Name" placeholder="last name" required>
								</div>
							</div>
							...
							<div class="form-row">
								...
								<div class="form-group col-md-6">
									...
									<input type="text" class="form-control" name="alt_number"  id="alt_number">
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-row">
								...
								<div class="form-group col-md-3">
									...
									<input type="text" class="form-control" name="zip_code" id="zip_code" placeholder="pin code">
								</div>
							</div>
							<div class="form-row">
								<div class="form-group col-md-6">  
					...
					age: {
						validators: {
							...
							lessThan: {
                        		value: 110,
                        		inclusive: true,
                        		message: 'Age should less than 110'
                   		 },
                   		 greaterThan: {
                       		 value: 10,
                       		 inclusive: false,
                        	message: 'Age should greater than 10'
                    	},
							notEmpty: {
